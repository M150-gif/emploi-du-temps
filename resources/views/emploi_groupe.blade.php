                    ...
                    <tr>
                        ...
                        @foreach ($jours as $jour)
                            @foreach($seances_order as $seance_order)
                                @php
                                    $seance = $seances->first(function($item) use ($jour, $part_of_day, $seance_order, $selectedGroupe) {
                                        return $item->day === $jour && in_array($item->partie_jour, $part_of_day) && $item->order_seance === $seance_order && $item->id_groupe == $selectedGroupe->id;
                                    });
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('ajouter_seance')}}" method="post">
                                            ...
                                            <input name="id_groupe" type="text" hidden value="{{$selectedGroupe->id}}">
