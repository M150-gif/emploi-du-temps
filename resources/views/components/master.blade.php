...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <ul class="dropdown-menu ms-4">
    ...
    @endforeach
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{route('emploi_formateur')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{route('emploi_groupe')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        @auth
                            <li class="nav-item d-flex align-items-center">
                                <a onclick="return confirm('Voulez Vous Vraiment déconnecter?')"
                                    href="{{ route('logout') }}" class="nav-link text-body font-weight-bold px-0 d-flex">
                                    <i class="material-icons opacity-10">login</i>
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0">
                ...
                <div class="d-flex">
                    ...
                    <button class="btn bg-gradient-dark px-3 mb-2 ms-2" data-class="bg-dark"
                        onclick="sidebarType(this)">White</button>
                    <button class="btn bg-gradient-dark px-3 mb-2 ms-2" data-class="bg-gradient-success"
                        onclick="sidebarType(this)">White</button>
                </div>
